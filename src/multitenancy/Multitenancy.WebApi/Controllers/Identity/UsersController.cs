...
namespace Genocs.MultitenancyAspire.WebApi.Controllers.Identity;
...
public class UsersController : VersionNeutralApiController
{
    ...
    [HttpGet]
    [MustHavePermission(GNXAction.View, GNXResource.Users)]
    ...
    [HttpGet("{id}/roles")]
    [MustHavePermission(GNXAction.View, GNXResource.UserRoles)]
    ...
    [MustHavePermission(GNXAction.Update, GNXResource.UserRoles)]
    ...
    [HttpPost]
    [MustHavePermission(GNXAction.Create, GNXResource.Users)]
    ...
    [MustHavePermission(GNXAction.Update, GNXResource.Users)]
    [ApiConventionMethod(typeof(GNXApiConventions), nameof(GNXApiConventions.Register))]
