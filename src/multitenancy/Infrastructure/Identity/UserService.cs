...
using Genocs.MultitenancyAspire.Application.Common.Models;
using Genocs.MultitenancyAspire.Application.Common.Specification;
...
internal partial class UserService : IUserService
{
    ...
    public async Task ToggleStatusAsync(ToggleUserStatusRequest request, CancellationToken cancellationToken)
    {
        ...
        bool isAdmin = await _userManager.IsInRoleAsync(user, GNXRoles.Admin);
        if (isAdmin)
        {
