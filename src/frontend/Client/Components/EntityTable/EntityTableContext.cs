...
public abstract class EntityTableContext<TEntity, TId, TRequest>
{
    ...
    /// <summary>
    /// The GNXResource that is representing this entity. This is used in combination with the xxActions to check for permissions.
    /// </summary>
    ...
    /// <summary>
    /// The permission name of the export permission. This is GNXAction.Export by default.
    /// </summary>
        ...
        Func<TEntity, bool>? canDeleteEntityFunc)
    {
        ...
        SearchAction = searchAction ?? GNXAction.Search;
        CreateAction = createAction ?? GNXAction.Create;
        UpdateAction = updateAction ?? GNXAction.Update;
        DeleteAction = deleteAction ?? GNXAction.Delete;
        ExportAction = exportAction ?? GNXAction.Export;
