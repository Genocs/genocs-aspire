...
public partial class UserRoles
{
    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        _canEditUsers = await AuthService.HasPermissionAsync(state.User, GNXAction.Update, GNXResource.Users);
        _canSearchRoles = await AuthService.HasPermissionAsync(state.User, GNXAction.View, GNXResource.UserRoles);
