...
namespace Genocs.BlazorAspire.Client.Pages.Multitenancy;
...
public partial class Tenants
{
    ...
    protected override async Task OnInitializedAsync()
    {
        Context = new(
            ...
            entityResource: GNXResource.Tenants,
        ...
        _canUpgrade = await AuthService.HasPermissionAsync(state.User, GNXAction.UpgradeSubscription, GNXResource.Tenants);
        _canModify = await AuthService.HasPermissionAsync(state.User, GNXAction.Update, GNXResource.Tenants);
    }
